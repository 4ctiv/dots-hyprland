if status is-interactive
    ...
    # systemd: https://www.tecmint.com/disable-suspend-and-hibernation-in-linux
    ...
    alias yay="paru"
    alias free="free -mt"
    alias gksudo="pkexec" # policy kit (polkit)
    ##################
    ## Update Stuff ##
    ##################
    ...
    #alias check-fish-start="time fish --profile-startup /tmp/startup.prof -c exit && sort -nk2 /tmp/startup.prof | less"
    ################
    ## List Stuff ##
    ################
    # Logs
    ...
    #verify signatures
    #function check-hash $ALGO $CSM $FILE
