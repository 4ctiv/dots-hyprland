...
# OPTIONAL
git clone --depth 1 https://github.com/dense-analysis/ale.git ~/.vim/pack/plugins/opt/ale
git clone --depth 1 https://github.com/vivien/vim-linux-coding-style ~/.vim/pack/plugins/opt/linuxsty
